...
import com.semorka.lyryx.ui.components.AlbumCoverBackground
import com.semorka.lyryx.ui.components.CenteredLyricWordView
...
fun LyricsScreenContent(
    ...
    val words by wordsVm.lyricsSegments.collectAsStateWithLifecycle()
    ...
    val currentSegment: LyricSegment? by remember(smoothTime, words) {
        derivedStateOf {
            words
