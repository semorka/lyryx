...
import com.semorka.lyryx.navigation.MainNavigation
...
import com.semorka.lyryx.sound.v2.PlaybackService
...
fun LyryxApp(){
    ...
    MainNavigation(navController, musicVm, lyricsVm, playerVm, wordsVm)
}